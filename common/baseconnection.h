...
public slots:
    ...
    void slotNewScannedPoints(const QVector3D& scanPosition, const QVector<QVector3D>& points);
    ...
    void slotNewCameraImage(const QString& name, const QSize& imageSize, const QVector3D& position, const QQuaternion& orientation, const QByteArray* image);
