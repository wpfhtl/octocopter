...
KopterControl::KopterControl(int argc, char **argv) : QCoreApplication(argc, argv)
{
    ...
    int rtkBasePort = 1234;
        ...
        connect(
                    mGpsDevice,
                    SIGNAL(gpsStatus(const quint8&, const quint8&, const quint8&, const quint8&, const quint8&, const quint8&, const QString&)),
                    mBaseConnection,
                    SLOT(slotNewGpsStatus(const quint8&, const quint8&, const quint8&, const quint8&, const quint8&, const quint8&, const QString&))
                );
